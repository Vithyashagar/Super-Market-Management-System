...
<html>
	...
	<body style="z-index:2;">
		...
		<div class="main">
			...
			<div class="container1" style="height:520px;width:82%;margin-left:11%;">
			<br>
			     	...
			     	<div class="right" style="width:30%;">
			        	...
			        	<%}
			          	...
			          	<%}%>
			           	...
			           	<label>Rs.<%=session.getAttribute("dCharge")%></label><br><br>
			            <label>(Rs.<%=session.getAttribute("offerAmount")%>)</label><br><br>
			            <label style="font-weight: bold;">Rs.<%=session.getAttribute("netTotal")%></label><br><br>
		           	</div>   
